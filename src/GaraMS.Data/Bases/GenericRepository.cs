...
namespace Skincare.Repositories.Bases
{
    public class GenericRepository<T> where T : class
    {
        protected GaraManagementSystemContext _context;

        public GenericRepository()
        {
            _context ??= new GaraManagementSystemContext();
        }

        public GenericRepository(GaraManagementSystemContext context)
        {
            _context = context;
        }
